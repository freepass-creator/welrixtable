...
Validation: Vercel build passed; root mobile manufacturer selection and Hyundai model navigation passed in preview. Production root readback required below. API source unchanged from user-selected preview; full quote calculation not regression-tested.
