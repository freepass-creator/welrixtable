...
.sr-snapshot {
  ...
  background: var(--brand-50); border-radius: var(--r-chip);
}
...
.sr-car__name { font-size: var(--fs-xl); font-weight: var(--fw-bold); color: var(--ink-1); letter-spacing: -0.4px; }
...
.sr-term {
  ...
  padding: 16px; background: var(--brand-50); border-radius: var(--r-card);
}
.sr-term__label { font-size: var(--fs-lg); font-weight: var(--fw-bold); color: var(--ink-1); }
...
.sr-term__monthly b {
  font-size: var(--fs-2xl); font-weight: var(--fw-bold); color: var(--brand);
  letter-spacing: -0.5px; font-variant-numeric: tabular-nums;
}
.sr-muted { color: var(--ink-4); }
.sr-error { margin: 4px 0 0; font-size: 13px; color: #c62828; }

.sr-cond { padding: 4px 16px; background: var(--bg-soft); border-radius: var(--r-card); }
.sr-cond__row {
