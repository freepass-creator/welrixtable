/* ============================================================================
 *  ★★폐기 대상 — 2026-09-18 대표 지시 「과거 거였나 보네. 그 안 씀으로 해놔, 폐기를 하든지」
 * ----------------------------------------------------------------------------
 *  이 파일의 «가격»을 믿지 마라. 제조사 가격표에 없는 숫자다.
 *
 *  현대 공식 가격표(the-new-grandeur-price.pdf)와 대조한 결과:
 *    트림          현대 공식      이 파일      웰릭스
 *    프리미엄      42,450,000   42,500,000 ✘  42,450,000 ✔
 *    익스클루시브   46,940,000   47,000,000 ✘  46,940,000 ✔
 *    캘리그래피    53,100,000   53,170,000 ✘  53,100,000 ✔
 *
 *  ★base_price_3_5 도, base_price_5 도 «현대 PDF 에 없는 숫자»다.
 *    2차 출처(카눈·다나와 등) 값에 개소세 3.5%→5% 환산을 «계산»해 얹은 것이다.
 *    그 계수가 1.0154 인데 실제 비율은 1.0141 이라 트림마다 5~7만원 높다.
 *
 *  ★대신 쓸 곳
 *    · 차량·가격  = 웰릭스 스냅샷 (_audit/welrix-netlify-20260917/vehicles-508.json)
 *                  또는 제조사 정본 = C:\devreepasserp4\data
ew-car\ (현대 공식표와 일치 확인)
 *    · 계산      = api/estimate.js (웰릭스 계산 서버 그대로)
 *
 *  ★아직 지우지 않은 이유 — index.html·home.html·guide.html 이 이 파일을 읽는다.
 *    그쪽을 옮긴 뒤에 지운다. 그때까지 «옵션 관계(설명·배타그룹·선행·포함)»는 계속 쓸 만하다
 *    (관계는 가격과 달리 낡지 않는다). 가격만 쓰지 않는다.
 * ========================================================================== */
